...
function removeQuestionaire(){
    ...
    for(var i = 0; i < ctrls_collection.length; i++){
        ...
        if($(ctrls_collection[i]) && $(ctrl_value_assoc[ctrls_collection[i]] + "_response_value")){
            if($(ctrls_collection[i]).type == "textbox"){
                $(ctrl_value_assoc[ctrls_collection[i]] + "_response_value").value = $(ctrls_collection[i]).value;
            } else {
                //$(ctrl_value_assoc[ctrls_collection[i]]).value = $(ctrls_collection[i]).checked;

                if($(ctrls_collection[i]).checked){

                    if($(ctrl_value_assoc[ctrls_collection[i]]+"_response_value")) $(ctrl_value_assoc[ctrls_collection[i]]+"_response_value").removeAttribute("disabled");
                    if($(ctrl_value_assoc[ctrls_collection[i]]+"_uuid")) $(ctrl_value_assoc[ctrls_collection[i]]+"_uuid").removeAttribute("disabled");
                    if($(ctrl_value_assoc[ctrls_collection[i]]+"_concept_uuid")) $(ctrl_value_assoc[ctrls_collection[i]]+"_concept_uuid").removeAttribute("disabled");
                    if($(ctrl_value_assoc[ctrls_collection[i]]+"_concept_name")) $(ctrl_value_assoc[ctrls_collection[i]]+"_concept_name").removeAttribute("disabled");
                    if($(ctrl_value_assoc[ctrls_collection[i]]+"_response_category")) $(ctrl_value_assoc[ctrls_collection[i]]+"_response_category").removeAttribute("disabled");

                } else {

                    if($(ctrl_value_assoc[ctrls_collection[i]]+"_response_value")) $(ctrl_value_assoc[ctrls_collection[i]]+"_response_value").setAttribute("disabled", true);
                    if($(ctrl_value_assoc[ctrls_collection[i]]+"_uuid")) $(ctrl_value_assoc[ctrls_collection[i]]+"_uuid").setAttribute("disabled", true);
                    if($(ctrl_value_assoc[ctrls_collection[i]]+"_concept_uuid")) $(ctrl_value_assoc[ctrls_collection[i]]+"_concept_uuid").setAttribute("disabled", true);
                    if($(ctrl_value_assoc[ctrls_collection[i]]+"_concept_name")) $(ctrl_value_assoc[ctrls_collection[i]]+"_concept_name").setAttribute("disabled", true);
                    if($(ctrl_value_assoc[ctrls_collection[i]]+"_response_category")) $(ctrl_value_assoc[ctrls_collection[i]]+"_response_category").setAttribute("disabled", true);
