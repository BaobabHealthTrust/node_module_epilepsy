...
function updateUI() {
    ...
    ajaxBookingRequest("/diabetes/bookings?start_date=" + start_date + "&end_date=" + end_date);
    ...
    if(counts[pos]){
        ...
        if(subtract){
            if(counts[pos][sel]){
                ...
                if(response){
                    ajaxBookingRequest("/diabetes/cancel_booking/"+patient_id+"?appointment_date="+app_date+"&start_date=" +
